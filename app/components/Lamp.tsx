    ...
    >
      ...
      >
        <motion.div
          ...
          className="bg-gradient-conic absolute inset-auto right-1/2 h-56 w-120 overflow-visible
            from-cyan-500 via-transparent to-transparent text-white
        ...
        >
          ...
          <div
            className="absolute bottom-0 left-0 z-20 h-full w-40 bg-slate-950
              mask-[linear-gradient(to_right,white,transparent)]"
          />
        </motion.div>
        <motion.div
          initial={{ opacity: 0.5, width: "15rem" }}
          ...
          className="bg-gradient-conic absolute inset-auto left-1/2 h-56 w-120 from-transparent
        ...
        ></div>
        <div
          className="absolute inset-auto z-50 h-36 w-md -translate-y-1/2 rounded-full bg-cyan-500
            opacity-50 blur-3xl"
        ></div>
        <motion.div
          initial={{ width: "8rem" }}
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-24 rounded-full bg-cyan-400
            blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
