    ...
    >
      <div className="relative isolate z-0 flex w-full flex-1 scale-y-125 items-center justify-center">
        <motion.div
          ...
          className="bg-gradient-conic absolute inset-auto right-1/2 h-56 w-120 overflow-visible from-cyan-500
        ...
        <motion.div
          ...
          className="bg-gradient-conic absolute inset-auto left-1/2 h-56 w-120 from-transparent via-transparent
