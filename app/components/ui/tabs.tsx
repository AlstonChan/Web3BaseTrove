...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      data-[state=active]:text-foreground inline-flex items-center justify-center rounded-sm px-3
      py-1.5 text-sm font-medium whitespace-nowrap transition-all focus-visible:ring-2
