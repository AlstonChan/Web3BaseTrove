...
export function TimePickerInput({
  ...
  return (
    <Input
      ...
      name={name || picker}
      className={cn(
        `focus:bg-accent focus:text-accent-foreground w-12 text-center font-mono text-base
        tabular-nums caret-transparent [&::-webkit-inner-spin-button]:appearance-none`,
        className,
      )}
